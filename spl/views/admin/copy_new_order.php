...
<div class="container-fluid" id="main">
    <div id="new_order">
        <h4>Order No: # <?php echo $this->order_id; ?><span class="small pull-right"><?php echo date("F j, Y, g:i a"); ?></span></h4>
        <hr>
        ...
        <div class="row-fluid" id="new_order_row_div">
            <div class="span3">
                <form id="save_order_form">
                    ...
                    <input type="text" name="prefered_transport" placeholder="Prefered transport"> 
                    <input type="text" name="discount_request" placeholder="Remarks">
                </form>
            </div>
            <div class="span9">
                ...
                <form class="form-inline" id="add_cart_form">
                    ...
                    <select name="package_id" class="input-xlarge">
                    ...
                    <input type="number" class="input-mini" placeholder="Boxes" name="quantity"> 
                    <input type="hidden" name="order_id" value="<?php echo $this->order_id; ?>">
...
<script type="text/javascript">
    ...
    function add_discount_n_tax(){
    	...
    	$('#add_discount_n_tax,#item_table_row,#item_tax_central').hide();
