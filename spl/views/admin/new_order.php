...
<script type="text/javascript">
    ...
    function get_discounts(customer_id) {
        ...
        $('#item_discount').append('<tr><td><strong>Total(+Excise Duty)</strong></td><td></td><td></td><td></td><td></td><td></td><td></td><td class="total_price">' + total_price + '</td><td class="ced">' + central_excise_duty + '</td><td class="edu_cess">' + education_cess + '</td><td class="higher_edu">' + higer_education_cess + '</td><td class="total_price_after_excise">' + total_price_after_excise + '</td><td></td></tr>');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var key in data) {
                    ...
                    $('#item_discount').append('<tr><td></td><td>' + data[key].name + '&nbsp;&nbsp;' + apply_discount + '</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>' + data[key].percentage + '&nbsp;%</td><td></td><td id="' + dis_val + '"></td><td>' + remove_discount + '</td></tr>');
                    i++;
                }
                ...
                $('#item_discount').append('<tr><td><strong>Total(after discount)</strong></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td id="total_after_discount" class="total_price_after_excise">' + total_price_after_excise + '</td><td></td></tr>');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var key in data) {
                    ...
                    $('#item_tax').append('<tr><td></td><td>' + data[key].name + '&nbsp;&nbsp;' + apply_tax + '</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>' + data[key].percentage + '&nbsp;%</td><td></td><td id="' + dis_val + '"></td><td>' + remove_tax + '</td></tr>');
                    i++;
                }
                ...
                $('#item_tax').append('<tr><td><strong>Total</strong></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td id="total_bill" class="total_price_after_excise">' + total_price_after_excise +'</td><td></td></tr>');
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (array_element['error'] != '') {
                    ...
                    $('#item_table_row').append('<tr id="order_item_row_' + array_element['order_item_id'] + '"><td style="display:none;">' + array_element['order_item_id'] + '</td><td>' + count + '</td><td>' + array_element['product_name'] + '</td><td>' 
                            + array_element[0].availibilityGD + '</td><td>' + array_element[0].availibilityRD + '</td><td>' + array_element['quantity'] + '</td><td>' + units + '</td><td>' + array_element['unit_price'] + '</td><td>' + price + '</td> <td>' 
                            + array_element['central_excise_duty'] + '</td> <td>' + array_element['education_cess'] + '</td> <td>' + array_element['higher_education_cess'] + '</td> <td>' 
                            + total_with_ced + '</td>  <td><a href="#" onclick="delete_product(' + array_element['order_item_id'] + ',' + price + ');"><i class="icon-remove"></i></a></td></tr>');
