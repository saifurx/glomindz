...
//Some Settings
            ...
            $DestinationDirectory = URL.'/assets/upload/'; //Upload Directory ends with / (slash)
            $Quality = 90;
//$path = URL."assets/uploded
...
//suitable if we want to compare the a variable with many different values
            switch (strtolower($ImageType)) {
                ...
                case 'image/pjpeg':
                    ...
                    break;
                default:
                    echo 'Unsupported File!'; //output error and exit
            }
...
//Get New Image Size
                ...
                $image_src_thumb= URL.'assets/upload/'.$ThumbPrefix . $NewImageName; 
                $image_src= URL.'assets/upload/'. $NewImageName;
                echo '<table width="100%" border="0" cellpadding="4" cellspacing="0">';
                echo '<tr>';
                echo '<td align="center"><img src="'.$image_src_thumb.'" alt="Thumbnail" height="' . $ThumbSquareSize . '" width="' . $ThumbSquareSize . '"></td>';
                echo '</tr><tr>';
                echo '<td align="center"><img src="' . $image_src . '" alt="Resized Image" height="' . $ResizedHeight . '" width="' . $ResizedWidth . '"></td>';
                echo '</tr>';
                echo '</table>';
...
// Resize Image
        if (imagecopyresampled($NewCanves, $SrcImage, 0, 0, 0, 0, $NewWidth, $NewHeight, $CurWidth, $CurHeight)) {
            ...
            switch (strtolower($ImageType)) {
                case 'image/png':
                    imagecreatefrompng($NewCanves, $DestFolder);
                    break;
                case 'image/gif':
