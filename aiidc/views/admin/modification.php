<div class="container">
	<div class="subnav subnav-fixed">
		<ul class="nav nav-pills">
			...
			<?php }else{?>
			<li class="active"><a href="<?php echo URL;?>admin/modification">Modified
					Data</a>
			</li>
			<?php }?>
