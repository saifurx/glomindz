<div id="wrap">	
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <span class="titleText">Members</span>
            </div>
            
            <div class="col-md-8">
                <input class="form-control"  type="search" id="search" placeholder="Search by Name ,mobile,designation or city">
            </div>
            <div class="col-md-2">
                ...
                <form role="form" id="create_police_user_form" class="form-horizontal">
                    <div class="col-md-6">
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" name="sms_user"> SMS User 
                        </label>
                        <!--  
                        <label class="normal_lable">Role</label>
...
<script type="text/javascript">
                                ...
                                function createPoliceUser() {
                                    ...
                                    if (validName == false) {
                                        $('#requiredNamespan').show();
                                    } else {
                                        $('#requiredNamespan').hide();
                                    }
                                    if (validEmail == false) {
                                        $('#requiredEmailspan').show();
                                    } else {
                                        $('#requiredEmailspan').hide();
                                    }
                                    if (validMobile == false) {
                                        $('#requiredMobilespan').show();
                                    } else {
                                        $('#requiredMobilespan').hide();
                                    }
                                    if (validName == true && validEmail == true && validMobile == true) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(resp) {
                                                $('form#create_police_user_form').each(function() {
                                                    this.reset();
                                                });
                                ...
                                function getAllPoliceUser(ps_id, search) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            for (var i in data) {
                                                var sms_user = '<td></td>';
                                                if (data[i].sms_user == 0) {
                                                    sms_user = '<td><a class="sms_is_disable label label-default" id="sms_' + data[i].id + '" href="#" title="Click to Enable">Disabled</a></td>';
                                                } else {
                                                    sms_user = '<td ><a class="sms_is_enable label label-success" id="sms_' + data[i].id + '" href="#" title="Click to Disable">Enabled</a></td>';
                                                }
                                                ...
                                                var row = '<tr id="row_' + data[i].id + '">'
                                                        ...
                                                        + '<td class="mobile">' + data[i].mobile + '</td>' + web_user + sms_user + resetpasswd + edit + '</tr>';
                                ...
                                //sms-user enable-disable
                                $("#police_users_tb").on("click", ".sms_is_disable", function() {
                                ...
                                $("#police_users_tb").on("click", ".sms_is_enable", function() {
                                    var user_id = $(this).closest("tr").find(".user_id").text();
                                    var name = $(this).closest("tr").find(".name").text();
                                    var mobile = $(this).closest("tr").find(".mobile").text();
                                    var user_type = 'police';
                                ...
                                function approve_sms_user(user_id, name, email, user_type, status) {
                                    $.ajax({
                                ...
                                function updateUserDetails() {
                                    ...
                                    if (validName == false) {
                                        $('#edit_requiredNamespan').show();
                                    } else {
                                        $('#edit_requiredNamespan').hide();
                                    }
                                    if (validEmail == false) {
                                        $('#edit_requiredEmailspan').show();
                                    } else {
                                        $('#edit_requiredEmailspan').hide();
                                    }
                                    if (validMobile == false) {
                                        $('#edit_requiredMobilespan').show();
                                    } else {
                                        $('#edit_requiredMobilespan').hide();
                                    }
                                    if (validName == true && validEmail == true && validMobile == true) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                $('form#edit_police_user_form').each(function() {
                                                    this.reset();
                                                });
                                            }
                                        });
