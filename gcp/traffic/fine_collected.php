...
<div class="">
	<div class="subNav">
		<span class="subNavtext">FINE COLLECTED</span>&nbsp;&nbsp;
	</div>
	...
	<div class="container" style=" height: auto;">
		<div class="row">
			...
			<div class="col-md-12" id="div_5years_data">
				<div id="chart_div_last5year_total_case" style="width: 800px; height: 450px; margin-top: 20px;"></div>
				
				<div id="chart_div_last5year_total_finecollection" style="width: 800px; height: 450px; margin-top: 20px;"></div>
