    ...
    <div class="row">
		    ...
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h3 class="panel-title">Paid  Hotels</h3>
		      </div>
              ...
              <input type="hidden" name="_token" id="cfr_token" value="<?php echo csrf_token(); ?>">
                  ...
                  <th>Pay Offline</th>
			        ...
			        <tbody>
                     ...
                     <td><button type="button" class="paidOffline btn btn-danger btn-xs">Send SMS</button></td>
                     <td><button type="button" class="paidOffline btn btn-danger btn-xs">Print Invoice</button></td>
